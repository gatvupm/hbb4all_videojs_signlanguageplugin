jwplayer().registerPlugin('signos01', '6.0', function(player, config, slowmo){
	function setup(evt){
		...
		if (player.getRenderingMode() == "html5"){
			...
			var usedPosition = "tl"; // tl=top-left; bl=bottom-left; br=bottom-right; tr=top-right;
			...
			extraeCurrentCaptions = function() {
				...
				if(currentCaptionsSet == "0")
				{
					currentCaptionTrackFileSet = matrixCaptionsTrackFiles[1];
				}
